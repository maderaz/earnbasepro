'use client';
/** Port of src/app/components/AssetSEOContent.tsx for the Next.js App Router. */
      ...
      <div className="bg-white dark:bg-card rounded-t-lg sm:rounded-[10px] border-y sm:border border-[#eff0f4] dark:border-border/20">
        ...
        {topVaults.length > 0 && (
          <Section>
            ...
            <div className="pt-3">
              <Link href={`/${tickerSlug}`} className="text-[13px] font-medium text-[#08a671] hover:underline">
                ...
                <tbody>
                  {networkRows.map(row => (
                    <tr key={row.networkSlug} className="border-b border-[#eff0f4] dark:border-border/20 last:border-b-0">
                      <td className="py-2.5">
                        <Link
                          href={`/${tickerSlug}/${row.networkSlug}`}
