'use client';
/** Port of src/app/components/CuratorPage.tsx for the Next.js App Router. */
...
// SEO handled server-side in page.tsx
...
export const CuratorPage: React.FC<CuratorPageProps> = ({ products, curatorSlug }) => {
